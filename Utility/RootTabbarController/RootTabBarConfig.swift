...
class RootTabBarConfig: NSObject {
    ...
    var centerImage: UIImage? = UIImage(named: "photo-nor")
    ...
    /// 文字 选中 色
    var titleColorSelected: UIColor? = UIColor(r: 199, g: 11, b: 56)
    /// 顶部线条 颜色
    ...
    /// 导航栏 标题 颜色
    var navBarTitleColor: UIColor? = .white
    /// 导航栏 title 字体
    var navBarTitleFont: UIFont? = UIFont.systemFont(ofSize: 17)
    /// 导航栏返回图片
    var navBackButtonImage: UIImage? = UIImage(named: "white_back")
